...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div>
                ...
                <div style="width: 50%; float: left">
                    ...
                    <asp:GridView CssClass="ctable" ID="gridBin" runat="server" Width="100%" AutoGenerateColumns="False" DataKeyNames="BinId" DataSourceID="DSBin" AllowPaging="True" AllowSorting="True" OnRowDeleted="gridBin_RowDeleted" OnRowUpdated="gridBin_RowUpdated" PageSize="20">
                        <Columns>
