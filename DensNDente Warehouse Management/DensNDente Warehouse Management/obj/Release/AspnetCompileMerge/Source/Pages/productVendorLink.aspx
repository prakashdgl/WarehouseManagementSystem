    ...
    <div style="width: 100%; float: left">
         ...
         <table>
              ...
              <tr>
                  ...
                  <td>
                      <asp:DropDownList Width="100px" ID="vendorName" AutoPostBack="true" DataValueField="id" DataTextField="name" runat="server" OnSelectedIndexChanged="vendorName_SelectedIndexChanged"></asp:DropDownList>
