...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="width: 100%; float: left;">
        ...
        <div>
            ...
            <asp:GridView CssClass="ctable" Width="100%" ID="gridRole" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="DsSafteyProduct">
                <Columns>
